 ...
 ******************************************************************************/
    ...
    /** Chave fixa: obrigatoria para flows_cred.json funcionar em mais de um PC.
     * Nao altere depois de comecar a usar (senhas dos nos seriam perdidas).
     */
    credentialSecret: process.env.NODE_RED_CREDENTIAL_SECRET || "510e894db9d554adaf0a4e5061a122e47d988f1d3921ea4e14e71e8bbea27b70",

    /** Desligado: o editor apagava nos de perfil ao salvar (exportOnSave sobrescrevia flows.json). */
    exportOnSave: false,
 ...
 ******************************************************************************/
     ...
     */
    /** Editor Node-RED em /admin para liberar / para o site VitaCare */
    httpAdminRoot: '/admin',
     ...
     */
    /** Site VitaCare (HTML/CSS/JS) na raiz http://127.0.0.1:1880/ */
    httpStatic: path.join(__dirname, 'frontend'),
    /**
 ...
 ******************************************************************************/
    ...
    editorTheme: {
        ...
        projects: {
            /** Git/Projects: instale Git for Windows e crie um repositorio remoto se quiser usar o menu Projects. */
            enabled: false,
            workflow: {
                mode: "auto"
            }
